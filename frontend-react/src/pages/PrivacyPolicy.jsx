  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', padding: '40px 24px', fontFamily: "'Cascadia Code','JetBrains Mono',monospace" }}>
      ...
      <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: 24 }}>
        ...
        <p style={S.p}>We set one httpOnly session cookie (<code style={{ color: C.teal }}>adapt_session</code>) used exclusively for authentication. We also use browser localStorage to persist your preferences and session state locally. No third-party cookies are set.</p>
